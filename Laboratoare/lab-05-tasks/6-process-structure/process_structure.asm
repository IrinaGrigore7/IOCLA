...
CMAIN:
    ...
    lea esi,[sample_student] ; TODO: store in a register the address of the sample_student struct
    mov edi, sample_student + id
    mov ecx, 3

    repnz movsb ; TODO: copy the first 3 bytes from the name field to id using movsb
    ...
    mov al, '-'
    mov byte [sample_student + id + 6], al
