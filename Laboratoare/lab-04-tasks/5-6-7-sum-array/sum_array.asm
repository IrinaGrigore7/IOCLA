...
add_byte_array_element:
    ...
    xor eax, eax
    xor edx, edx 
add_word_array_element1:
    mov dx, word [word_array + 2*(ecx - 1)]
    add eax, edx
    loop add_word_array_element1 ; Decrement ecx, if not zero, add another element.
...
add_dword_array_element2:
    ...
    add eax, edx
    loop add_dword_array_element2 ; Decrement ecx, if not zero, add another element.
